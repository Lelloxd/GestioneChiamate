...
<html><head>
				...
				<a class="navbar-brand" href="#">
				 ...
				 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">	
					 <ul class="nav navbar-nav">
                                         ...
                                         <li class="active"><a href="#">ANAGRAFICHE  <span class="sr-only">(current)</span></a></li>
    ...
    <div class='header-chiamate testata'>RICERCA ANAGRAFICA</div>
        <div class='chiamata-attiva'>
            <div class='middle' align='center'>
                
                <div class="searchcont befcontent"><br><p class='descl'>| CERCA  : </p>
                        <p class='form-inline'><input type='text' id='descrizione' class='form-control sini' placeholder='Ragione sociale'>
                       <a href='javascript:acerca();'><span class='glyphicon glyphicon-search'></span></a> <br>
                      <?php
            ...
            <script>
                document.getElementById('descrizione').oninput= function(e)
                {
                        acerca();
                };
            </script>
